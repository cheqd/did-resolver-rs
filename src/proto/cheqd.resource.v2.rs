...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::QueryResourceResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static("/cheqd.resource.v2.Query/Resource");
        ...
        ) -> std::result::Result<tonic::Response<super::QueryResourceMetadataResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/cheqd.resource.v2.Query/ResourceMetadata");
            let mut req = request.into_request();
